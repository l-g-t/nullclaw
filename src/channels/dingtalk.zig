...
pub const DingTalkChannel = struct {
    ...
    pub fn sendRichMessage(self: *DingTalkChannel, target: []const u8, payload: root.OutboundPayload) !void {
        ...
        try self.postJson(reply_target.webhook_url, json_fbs.getWritten());
    }
